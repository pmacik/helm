...
mv -f openshift/OWNERS_ALIASES openshift/OWNERS . # (re)place OWNERS* files in the current workspace
git add openshift OWNERS_ALIASES OWNERS # add the openshift directory and the OWNERS* to the release-next branch
...
# Update downstream's openshift branch
git checkout -B openshift downstream/master # switch to downstream/master
